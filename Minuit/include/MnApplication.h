...
extern FCNMonitor FCNMonitorDefault;
...
//  const FCNMonitorBase& fcnmonitor() const {return theMonitor;}
//  void	setFunctionMonitor(const FCNMonitorBase& fcn) {theMonitor = fcn;}

protected:

  const FCNBase& theFCN;
//  FCNMonitorBase& theMonitor;
