...
#include "ui_essistmemainwindow.h"
#include <QtCore>
...
ESsistMe_SpectrumWindow::ESsistMe_SpectrumWindow(QCustomPlot *parent) :
    QMainWindow(parent)
{
  //  spectrumPlot = parent;
}
...
*/
ESsistMe_ResidualWindow::ESsistMe_ResidualWindow(QCustomPlot  *parent) :
    QMainWindow(parent)
{
 //   ui->setupUi(this); // It is set up by the main window
...
ESsistMe_NavigatorWindow::ESsistMe_NavigatorWindow(ESsistMe_MainWindow *parent) :
    QMainWindow(parent)
{
//    ui->setupUi(this); // It is set up by the main window
 //   setGeometry(this->geometry());
